...
public class Service_citas {
    ...
    try{
        Object medico = medicoCliente.obtenerMedicoPorId(cita.getMedicoId());
        System.out.println("MEDICO OK: " + medico);
    ...
    try{
        Object paciente = pacienteCliente.obtenerPacientePorId(cita.getPacienteId());
        System.out.println("PACIENTE OK: " + paciente);
